...
- **[Port std::arch test suite to rust-lang/rust](https://summerofcode.withgoogle.com/programs/2026/projects/Aak8J6RB)** by [Sumit Kumas](https://github.com/xonx4l), mentored by [Jakub Beránek](https://github.com/Kobzol) and [Folkert de Vries](https://github.com/folkertdev)
- **[Reorganizing tests/ui/issues](https://summerofcode.withgoogle.com/programs/2026/projects/l4jlMDP9)** by [Matthew](https://github.com/zedddie), mentored by [Teapot](https://github.com/Teapot4195) and [Kivooeo](https://github.com/Kivooeo)
