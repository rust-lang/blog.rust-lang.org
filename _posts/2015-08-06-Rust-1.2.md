...
Today marks the end of another Rust release cycle: we are [releasing][install]
Rust 1.2 stable and 1.3 beta!
...
- **An across-the-board improvement** reaching 30% on some benchmarks. Compiling
  Cargo's main crate is now 18% faster.
...
[preliminary support for Windows XP](https://github.com/rust-lang/rust/pull/26601). While
