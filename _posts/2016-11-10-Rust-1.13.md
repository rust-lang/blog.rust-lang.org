...
It's been a busy season in Rust. We just powered through three Rust conferences,
[RustConf], [RustFest], and [Rust Belt Rust], in short succession. It was great
to see so many Rustaceans in person, some for the first time! We've been
[thinking a lot] about the future, developing a [roadmap for 2017], and
[building the tools] our users [tell us] they need.
...
additions to cargo and the standard library, and enhancements
to documentation and error reporting.
