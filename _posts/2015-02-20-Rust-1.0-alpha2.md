---
layout: post
title: "Announcing Rust 1.0-alpha2"
author: Steve Klabnik
description: "Rust 1.0-alpha2 has been released."
---

Today, we are happy to announce the release of Rust 1.0.0.alpha.2! Rust is a
systems programming language perusing the trifecta: safe, fast, and concurrent.
...
* `Adolfo OchagavÃ­a <aochagavia92@gmail.com>`
...
* `BjÃ¶rn Steinbrink <bsteinbr@gmail.com>`
...
* `Dominik InfÃ¼hr <dominik.infuehr@gmail.com>`
...
* `Filip SzczepaÅ„ski <jazz2rulez@gmail.com>`
...
* `John KaÌŠre Alsaker <john.kare.alsaker@gmail.com>`
* `John KÃ¥re Alsaker <john.kare.alsaker@gmail.com>`
* `Jonathan Reem <jonathan.reem@gmail.com>`
* `JONNALAGADDA Srinivas <js@ojuslabs.com>`
* `Jorge Aparicio <japaricious@gmail.com>`
* `Jorge Israel PeÃ±a <jorge.israel.p@gmail.com>`
...
* `LoÃ¯c Damien <loic.damien@dzamlo.ch>`
...
* `MÃ¡tyÃ¡s Mustoha <mmatyas@inf.u-szeged.hu>`
...
* `SÃ©bastien Marie <semarie@users.noreply.github.com>`
...
* `Toni CÃ¡rdenas <toni@tcardenas.me>`
