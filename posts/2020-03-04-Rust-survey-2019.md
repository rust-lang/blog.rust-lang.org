...
Additionally, many users indicated that they were not feeling comfortable in Rust - even after over 3 months of use. 

This may be an issue with language complexity, but it might also be related to tooling or other obstacles (integrated development environments in particular). This is a good place for us to investigate through follow-up surveys or other work.
...
These results are similar to what we suspect keeps users from feeling comfortable in Rust - especially training/documentation and IDE integration. We will be investigating this further in order to best allocate resources.
...
Thank you to all who participated in this survey - these results are immensely helpful when we plan how to allocate resources to improve both Rust the language and the entire Rust ecosystem. We look forward to continuing working for and with you for 2020 and beyond!