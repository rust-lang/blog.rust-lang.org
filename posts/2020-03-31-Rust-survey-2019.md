...
![How has the learning curve improved](/images/2020-03-RustSurvey/learning-curve-improvement.svg)

![How has tools and support improved](/images/2020-03-RustSurvey/tools-and-support-improvement.svg)
...
We first focused on users who had used Rust in the past, but had stopped using it.

First, let's focus on users who had stopped using Rust less than a year ago.

![Stopped using Rust less than a year ago - How long did you use Rust](/images/2020-03-RustSurvey/33-stopped-using-rust-less-than-year-ago-how-long-used-rust.svg)

Most had used Rust anywhere form less than a week to less than a year. 

Now, let's focus on users who had stopped using Rust more than a year ago.

![Stopped using Rust more than a year ago - How long did you use Rust](/images/2020-03-RustSurvey/34-stopped-using-rust-more-than-year-ago-how-long-used-rust.svg)
...
![How can we make Rust more appealing to your company](images/2020-03-RustSurvey/21-Rust-more-appealing.svg)
...
![How can we make Rust more appealing to your company](images/2020-03-RustSurvey/28-dependencies-1.0-or-above.svg)
